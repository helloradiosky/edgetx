...
static const struct YamlNode struct_RadioData[] = {
  ...
  YAML_SIGNED( "imuxdead", 8 ),
  YAML_SIGNED( "imuxp", 8 ),
  YAML_SIGNED( "imuxi", 8 ),
  YAML_SIGNED( "imuxd", 8 ),
  YAML_SIGNED( "imuydead", 8 ),
  YAML_SIGNED( "imuyp", 8 ),
  YAML_SIGNED( "imuyi", 8 ),
  YAML_SIGNED( "imuyd", 8 ),
  YAML_SIGNED( "imuzdead", 8 ),
  YAML_SIGNED( "imuzp", 8 ),
  YAML_SIGNED( "imuzi", 8 ),
  YAML_SIGNED( "imuzd", 8 ),
  YAML_SIGNED( "aivoiceswitch", 8 ),
  YAML_SIGNED( "voivech56switch", 8 ),
  YAML_SIGNED( "extModuleprotect", 8 ),
  YAML_SIGNED( "intModuleprotect", 8 ),
  YAML_SIGNED( "extmaxcurrent", 16 ),
  YAML_SIGNED( "inttmaxcurrent", 16 ),
  YAML_SIGNED( "gyroHeadCH78switch", 8 ),
  YAML_SIGNED( "usbchgprotect", 8 ),
  YAML_END
};
