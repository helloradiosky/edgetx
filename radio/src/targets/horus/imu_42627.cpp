...
#define MPU3050_ADDRESS         0x69        /* MPU3050的7位地址  <<1=d2 */
...
/*mpu3050寄存器定义 */
#define MPU42627_ID            0x75         //设备0x68+bit0
#define MPU3050_ID             0x00         //设备0x68+bit0

#define MPU3050_PID            0x00         // 产品id，
#define MPU3050_OFFSET_XH      0x0C 
#define MPU3050_OFFSET_XL      0x0D         //X偏移寄存器
#define MPU3050_OFFSET_YH      0x0E 
#define MPU3050_OFFSET_YL      0x0F         //Y偏移寄存器
#define MPU3050_OFFSET_ZH      0x10 
#define MPU3050_OFFSET_ZL      0x11         //Z偏移寄存器
#define MPU3050_FIFO_EN        0x12         //FIFO使能配置 0x00 
#define MPU3050_AUX_VDD        0x13         //加速度接口电平选择 0x00（vlogic） 0x04（vdd）
#define MPU3050_AUX_ADD        0x14         //7位加速度设备地址（D7~D0）D8：clkout使能
#define MPU3050_SAMP_DIV       0x15         //采样率配置 0x00   Fsam=Fin/（divider+1） Fin=1k or 8k
#define MPU3050_DLPF           0x16         // 000 00 000
#define MPU3050_INT            0x17         //中断配置0x00 
#define MPU3050_AUX_RADD       0x18         //读取加速度数据起始地址0x00
#define MPU3050_INTS           0x1A         //中断状态寄存器
#define MPU3050_TEMP_H         0x1B         //温度
#define MPU3050_TEMP_L         0x1C 
#define MPU3050_XOUTH          0x1D         //x轴陀螺仪数据
#define MPU3050_XOUTL          0x1E 
#define MPU3050_YOUTH          0x1F         //y轴陀螺仪数据
#define MPU3050_YOUTL          0x20 
#define MPU3050_ZOUTH          0x21         //z轴陀螺仪数据
#define MPU3050_ZOUTL          0x22 
#define MPU3050_AXOUTH         0x23         //加速度数据x
#define MPU3050_AXOUTL         0x24
#define MPU3050_AYOUTH         0x25         //加速度数据y
#define MPU3050_AYOUTL         0x26 
#define MPU3050_AZOUTH         0x27         //加速度数据z
#define MPU3050_AZOUTL         0x28 
#define MPU3050_FIFO_CH        0x3A         //FIFO计数寄存器
#define MPU3050_FIFO_CL        0x3B 
#define MPU3050_FIFO_DATA      0x3C         //FIFO数据
#define MPU3050_USER_CON       0x3D         //用户控制寄存器
#define MPU3050_POW_MGM        0x3E         //电源管理寄存器

#define MPU3050_XYZOUT         0x9D         //x轴陀螺仪数据
