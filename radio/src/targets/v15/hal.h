...
#define KEYS_GPIO_PIN_PAGEUP          LL_GPIO_PIN_15
#define KEYS_GPIO_REG_PAGEDN          GPIOB
#define KEYS_GPIO_PIN_PAGEDN          LL_GPIO_PIN_14
...
#define SWITCHES_GPIO_PIN_A_L           LL_GPIO_PIN_1 // PC.01
#define SWITCHES_GPIO_REG_A_H           GPIOC
#define SWITCHES_GPIO_PIN_A_H           LL_GPIO_PIN_0  // PC.00

#define SWITCHES_GPIO_REG_B_L           GPIOB
#define SWITCHES_GPIO_PIN_B_L           LL_GPIO_PIN_7 // PB.07
#define SWITCHES_GPIO_REG_B_H           GPIOE
#define SWITCHES_GPIO_PIN_B_H           LL_GPIO_PIN_5  // PE.05

#define SWITCHES_GPIO_REG_C_H           GPIOE
#define SWITCHES_GPIO_PIN_C_H           LL_GPIO_PIN_3   // PE.03
#define SWITCHES_GPIO_REG_C_L           GPIOG
#define SWITCHES_GPIO_PIN_C_L           LL_GPIO_PIN_14  // PG.14

#define SWITCHES_GPIO_REG_D_H           GPIOG
#define SWITCHES_GPIO_PIN_D_H           LL_GPIO_PIN_9  // PG.09
#define SWITCHES_GPIO_REG_D_L           GPIOJ
#define SWITCHES_GPIO_PIN_D_L           LL_GPIO_PIN_14   // PJ.14
...
#define ADC_GPIO_PIN_BATT               LL_GPIO_PIN_4      // PC.04 ADC12_INP4
...
#define ADC_CHANNEL_STICK_LV            LL_ADC_CHANNEL_17
#define ADC_CHANNEL_STICK_RV            LL_ADC_CHANNEL_15
#define ADC_CHANNEL_STICK_RH            LL_ADC_CHANNEL_14

#define ADC_CHANNEL_POT1                LL_ADC_CHANNEL_12
#define ADC_CHANNEL_POT2                LL_ADC_CHANNEL_13
#define ADC_CHANNEL_POT3                LL_ADC_CHANNEL_8
#define ADC_CHANNEL_BATT                LL_ADC_CHANNEL_4
...
//Ext port battery voltage sense
#define EXT_UART_POWER                GPIO_PIN(GPIOD, 7)  //POWER for external
#define CHIP_CS1_GPIO                 GPIO_PIN(GPIOJ, 11) //HC138 SELECT CS1  
#define CHIP_CS2_GPIO                 GPIO_PIN(GPIOI, 1)  //HC138 SELECT CS2
#define CHIP_CS3_GPIO                 GPIO_PIN(GPIOD, 11) //HC138 SELECT CS3
#define CHIP_FUN_GPIO                 GPIO_PIN(GPIOJ, 7)  //FUN SELECT CS

//Exp esp32
#define EXP_ESP32C3_PWR_GPIO            GPIO_PIN(GPIOG, 12) //esp32 POWER
#define EXP_ESP32C3_BOOTCMD_GPIO        GPIO_PIN(GPIOJ, 13)  //esp32 BOOT CMD
#define EXP_ESP32C3_PAEN                GPIO_PIN(GPIOD, 3)  //Audio PAEN
...
#define TRAINER_IN_GPIO                 GPIO_PIN(GPIOI, 0)  //
#define TRAINER_IN_TIMER_Channel        LL_TIM_CHANNEL_CH4

#define TRAINER_OUT_GPIO                GPIO_PIN(GPIOH, 12)  // 
...
#define XIAOZHI_UART_TX_GPIO                GPIO_PIN(GPIOB, 6) // PB.6
#define XIAOZHI_UART_RX_GPIO                GPIO_PIN(GPIOB, 5) // PB.5
#define XIAOZHI_UART_USART                  UART5
#define XIAOZHI_UART_USART_IRQHandler       UART5_IRQHandler
#define XIAOZHI_UART_USART_IRQn             UART5_IRQn
// Conflict-free DMA mapping for V15 XiaoZhi UART5 link
#define XIAOZHI_UART_DMA_TX                 DMA2
#define XIAOZHI_UART_DMA_TX_STREAM          LL_DMA_STREAM_7
#define XIAOZHI_UART_DMA_TX_CHANNEL         LL_DMAMUX1_REQ_UART5_TX
#define XIAOZHI_UART_DMA_RX                 DMA1
#define XIAOZHI_UART_DMA_RX_STREAM          LL_DMA_STREAM_4
#define XIAOZHI_UART_DMA_RX_CHANNEL         LL_DMAMUX1_REQ_UART5_RX
