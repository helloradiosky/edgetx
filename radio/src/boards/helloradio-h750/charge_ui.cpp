...
#if defined(COLORLCD) && defined(MODULE_BATTERY_SENSOR) && defined(USB_CHARGER)
...
{
  v15_charge_detail::chargeUiTask();
}

#if defined(RADIO_V15)
void v15ShutdownWaitIfCharging(void)
{
  v15_charge_detail::shutdownChargeWait();
}
#endif
